...
For Experience WODs like E18, I used AI mainly to help me get unstuck at the beginning. I prompted ChatGPT with something like: “Explain how to approach this WOD step by step without giving the full solution.” This was useful for understanding the structure of the task, but I avoided asking for full code because the solutions often didn’t match the exact WOD constraints, and relying too much on AI slowed me down when debugging.
### In-class Practice WODs
During in-class Practice WODs, I occasionally asked AI questions such as: “Can you give a simple example of using map and filter together in JavaScript?” AI was helpful for quick conceptual refreshers, but I found it less useful under time pressure since reading and adapting AI responses took longer than reasoning through the problem myself.
### In-class WODs
For in-class WODs, I generally did not use AI. I felt it was important to practice solving problems independently and under realistic constraints, since using AI would not be available during exams or graded assessments. When I briefly tried AI for one WOD, the response was too generic and didn’t align well with the specific instructions.
### Essays
...
### Documenting code
For documentation, I used prompts like: “Write a short JSDoc comment for this function.” AI was effective at producing clear documentation quickly, with minimal downsides as long as I verified accuracy.
### Quality assurance e.g. “What’s wrong with this code <code here>” or “Fix the ESLint errors in <code here>”
For QA tasks, I asked questions such as: “What’s causing this ESLint error in my code?” AI was especially useful here, as it helped identify common mistakes quickly, though I still needed to understand the fix to avoid repeating the same error later.
